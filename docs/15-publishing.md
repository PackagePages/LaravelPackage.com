...
description: 'This section covers publishing a package by submission to Packagist, which allows the end user to pull in the package using Composer. Additionally, the section will cover semantic versioning and releasing newer versions of a package.'
